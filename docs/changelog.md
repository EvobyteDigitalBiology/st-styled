...
### Added
- Align Streamlit version 1.60
- Add st.skeletion and st.mermaid_chart

## v0.5.0 - [2026-05-29]

### Added
- Add pre-configured theme templates for rapid styling of Streamlit apps

### Bugfix
- split_button: Fix conflicts with primary button font size prefixes
